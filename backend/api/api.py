...
app = Flask(__symptoms__)
api = Api(app)

app.config['MONGO_DBNAME'] = 'illness'
app.config['MONGO_URI'] = 'mongodb://root:gvOIqn8DJ8tvHz%!@mongodb:27017/?authSource=admin'
